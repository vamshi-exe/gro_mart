...
import 'package:gromart_customer/ui/gift_card/gift_card_history_list_screen.dart';
import 'package:gromart_customer/ui/gift_card/gift_card_purchase_screen.dart';
import 'package:gromart_customer/ui/gift_card/gift_card_redeem_screen.dart';
...
class _GiftCardScreenState extends State<GiftCardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Customize Gift Card".tr(),
            style: TextStyle(
                          ...
                          onPageChanged: (value) {
                            setState(() {
                              ...
                              messageController.text =
                                  giftCardList[currentPage].message.toString();
                            });
                          },
                      ...
                      child: Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text("Choose amount".toUpperCase().tr(),
                                style: TextStyle(
                                    fontSize: 16,
                                    color: isDarkMode(context)
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(
                                    "${selectedAmount == "Custom" ? "" : amountShow(amount: selectedAmount)}",
                                    style: TextStyle(
                                        fontSize: 16,
                                        color: isDarkMode(context)
                                            ? Colors.white
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 18),
                            child: Text("Add Message (Optional)".toUpperCase().tr(),
                                style: TextStyle(
                                    fontSize: 16,
                                    color: isDarkMode(context)
                                        ? Colors.grey.shade700

...
import 'package:gromart_customer/model/StripePayFailedModel.dart';
import 'package:gromart_customer/model/createRazorPayOrderModel.dart';
import 'package:gromart_customer/model/getPaytmTxtToken.dart';
...
import 'package:gromart_customer/model/payStackURLModel.dart';
...
import 'package:gromart_customer/ui/wallet/MercadoPagoScreen.dart';
import 'package:gromart_customer/ui/wallet/payStackScreen.dart';
import 'package:http/http.dart' as http;
import 'package:gromart_customer/services/helper.dart';
import 'package:gromart_customer/services/paystack_url_genrater.dart';
import 'package:gromart_customer/services/rozorpayConroller.dart';
import 'package:gromart_customer/ui/wallet/PayFastScreen.dart';
...
class _GiftCardPurchaseScreenState extends State<GiftCardPurchaseScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Complete purchase".tr(),
            style: TextStyle(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                "${"Gift Card expire".tr()}  ${giftCardModel.expiryDay} ${"days after purchase".tr()} ",
  ...
  _flutterWaveInitiatePayment(
    ...
    final flutterwave = Flutterwave(
      ...
      customization: Customization(title: "GroMart"),
      txRef: _ref!,

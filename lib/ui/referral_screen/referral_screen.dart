...
class _ReferralScreenState extends State<ReferralScreen> {
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Invite GroMart to sign up using your code and you’ll get".tr() +
  ...
  Future<void> share() async {
    ...
    await FlutterShare.share(
      title: 'GroMart'.tr(),
      text: "Hey there, thanks for choosing GroMart. Hope you love our product. If you do, share it with your friends using code".tr() +
          " ${referralModel!.referralCode.toString()} " +
          "and get".tr() +
          "${amountShow(amount: referralAmount.toString())} " +

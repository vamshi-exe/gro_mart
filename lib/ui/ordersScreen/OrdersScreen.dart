...
import 'package:gromart_customer/ui/orderDetailsScreen/OrderDetailsScreen.dart';
          ...
          : StreamBuilder<List<OrderModel>>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
                  return Center(
                    child: showEmptyState('No Previous Orders'.tr(), context, description: "Let's orders item!".tr()),
                  );
                } else {

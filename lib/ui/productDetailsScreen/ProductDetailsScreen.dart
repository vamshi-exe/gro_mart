...
import 'package:gromart_customer/model/ItemAttributes.dart';
...
import 'package:gromart_customer/model/variant_info.dart';
import 'package:gromart_customer/services/FirebaseHelper.dart';
import 'package:gromart_customer/services/Indicator.dart';
...
import 'package:gromart_customer/ui/vendorProductsScreen/review.dart';
        ...
        for (var element in attributes!) {
          if (element.attributeOptions!.isNotEmpty) {
            ...
            selectedIndexVariants
                .add('${attributes!.indexOf(element)} _${attributes![0].attributeOptions![0].toString()}');
                          ...
                          children: [
                                            ...
                                            children: [
                                              Text(
                                                widget.productModel.reviewsCount != 0
                                                    ? (widget.productModel.reviewsSum /
                            ...
                            widget.productModel.disPrice == "" || widget.productModel.disPrice == "0"
                                ? Text(
                                    ...
                                    style: TextStyle(
                                        fontFamily: "Poppinsm", letterSpacing: 0.5, color: Color(COLOR_PRIMARY)),
                                  )
                                : Row(
                                    children: [
                                      Text(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  fontFamily: "Poppinsl",
                                  color: isDarkMode(context) ? const Color(0xffC6C4C4) : const Color(0xff5E5C5C)),
                            ),
                          ],
                        ),
                      ),
                                                    ...
                                                    onTap: () async {
                                                      setState(() {
                                                        if (selectedIndexVariants
                                                            .where((element) => element.contains('$index _'))
                                                            .isEmpty) {
                                                          selectedVariants.insert(index,
                                                          ...
                                                          selectedIndexVariants.remove(selectedIndexVariants
                                                              .where((element) => element.contains('$index _'))
                                                              .first);
                                                          selectedVariants.insert(index,
                                                              attributes![index].attributeOptions![i].toString());
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Text("proteins".tr(),
                                            style: const TextStyle(fontSize: 16, fontFamily: "Poppinsl"))
                                      ],
                                    ),
                                    Column(
                                      children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        fontFamily: "Poppinsm",
                                        fontSize: 16,
                                        color: isDarkMode(context) ? const Color(0xffffffff) : const Color(0xff000000)),
                                  ),
                                ),
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 15),
                                                      ...
                                                      for (var element in attributes!) {
                                                        mapData.addEntries([
                                                          MapEntry(
                                                              attributesList
                                                                  .where(
                                                                      (element1) => element.attributesId == element1.id)
                                                                  .first
                                                                  .title
                                                                  .toString(),
                                                      ...
                                                      for (int a = 0; a < lstTemp.length; a++) {
                                                        if (lstTemp[a].index == index &&
                                                            lstTemp[a].categoryID ==
                                                                lstAddAddonsCustom[index].categoryID) {
                                                          removeIndex = a;
                                                          break;
                                                        }
                                                      }
                                          ...
                                          children: [
                                            Text(widget.productModel.specification.keys.elementAt(index) + " : ",
                                                style: TextStyle(
                                                    ...
                                                    fontSize: 14)),
                                            Expanded(
                                              child: Text(widget.productModel.specification.values.elementAt(index),
                                    ...
                                    InkWell(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                            ...
                                            fontSize: 16,
                                            color:
                                                isDarkMode(context) ? const Color(0xffffffff) : Color(COLOR_PRIMARY)),
                                      ),
                                    ),
                                  ],
                                ),
                                          ...
                                          child: GestureDetector(
                                            onTap: () async {
                                              VendorModel? vendorModel =
                                                  await FireStoreUtils.getVendor(storeProductList[index].vendorID);
                                              if (vendorModel != null) {
                                                push(
                                                  context,
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        for (var element in reviewAttributeList) {
                                          if (element.id ==
                                              widget.productModel.reviewAttributes!.keys.elementAt(index)) {
                                            reviewAttribute = element;
                                          }
                                        }
                                        ReviewsAttribute reviewsAttributeModel = ReviewsAttribute.fromJson(
                                            widget.productModel.reviewAttributes!.values.elementAt(index));
                                        return Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              RatingBar.builder(
                                                ignoreGestures: true,
                                                initialRating: (reviewsAttributeModel.reviewsSum!.toDouble() /
                                                    reviewsAttributeModel.reviewsCount!.toDouble()),
                                                minRating: 1,
                                                itemSize: 20,
                                              ...
                                              Text(
                                                (reviewsAttributeModel.reviewsSum!.toDouble() /
                                                        reviewsAttributeModel.reviewsCount!.toDouble())
                                                    .toStringAsFixed(1),
                                                      ...
                                                      itemBuilder: (context, index1) {
                                                        return Padding(
                                                          ...
                                                          child: CachedNetworkImage(
                                                            ...
                                                            width: 65,
                                                            imageUrl:
                                                                getImageVAlidUrl(reviewList[index].photos![index1]),
                                                            imageBuilder: (context, imageProvider) => Container(
                                                              decoration: BoxDecoration(
                                                                borderRadius: BorderRadius.circular(10),
                                                                image: DecorationImage(
                                    ...
                                    if (MyAppState.currentUser == null) {
                                      ...
                                      setState(() {
                                        if (variants!
                                          ...
                                          if (widget.productModel.quantity > productQnt ||
                          ...
                          GestureDetector(
                            onTap: () {
                              if (MyAppState.currentUser == null) {
                                ...
                                pushAndRemoveUntil(context, CartScreen(), false);
                              }
                            },
                            child: Text(
                              "VIEW CART".tr(),
  ...
  addtocard(ProductModel productModel, bool isIncerementQuantity) async {
    ...
    if (productQnt > 1) {
      ...
      final bool _productIsInList = cartProducts.any((product) =>
          ...
          productModel.id +
              "~" +
              (productModel.variantInfo != null ? productModel.variantInfo!.variantId.toString() : ""));
      if (_productIsInList) {

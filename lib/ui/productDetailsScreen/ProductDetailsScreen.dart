                            ...
                            if (contain.isNotEmpty) {
                              ...
                              FavouriteItemModel favouriteModel =
                                  FavouriteItemModel(
                                      ...
                                      userId: MyAppState.currentUser!.userID);
                              FireStoreUtils()
                                  .setFavouriteStoreItem(favouriteModel);
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                                                                ...
                                                                children: [
                                                                  Text(
                                                                      productModel.reviewsCount !=
                                                                              0
                                                                          ? (productModel.reviewsSum / productModel.reviewsCount).toStringAsFixed(
                                                                              1)
                                                                          : 0
                                                                              .toString(),
                                                                      style:
                      ...
                      Visibility(
                        visible:
                            widget.productModel.reviewAttributes!.isNotEmpty,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: ListView.builder(
                                itemCount: reviewList.length > 10
                                    ? 10
                                    : reviewList.length,
                                shrinkWrap: true,
                                padding: EdgeInsets.zero,
                                        ...
                                        setState(() {
                                          if (variants!
                                            ...
                                            if (int.parse(variants!
                                              ...
                                              widget.productModel.variantInfo =
                                                  variantInfo;
